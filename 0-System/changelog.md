...
- System review fixes, spec moves, and vault updates
- Consolidate directory structure and fix naming inconsistencies
...
- Directory restructuring — vault content moved to `` subdirectory

### Changed

- Document upgrade notes system across versioning and component guides
- Core vault structure reorganized under `` for cleaner project layout
