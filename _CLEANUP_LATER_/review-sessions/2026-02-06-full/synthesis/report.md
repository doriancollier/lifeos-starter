...
- `0-System/guides/meeting-workflow.md:376,437` - `0-System/scripts/supernormal/`
- `.gitignore:29-30` - `0-System/scripts/supernormal/`
...
**Problem**: References `3-Resources/Documentation/`
**Fix**: Update to `0-System/guides/`
...
Many commands mix `{{vault_path}}/...`, `.claude/...`, and `...` formats.
...
1. **`contacts-config.json` missing** - Actually EXISTS at `0-System/config/contacts-config.json`
2. **`health-config.md` missing** - Actually EXISTS at `0-System/config/health-config.md`
3. **`learning-log.md` missing** - Actually EXISTS at `0-System/config/learning-log.md`
