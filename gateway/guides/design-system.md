...
| Concern | File |
|---------|------|
| CSS variables & Tailwind | `src/client/index.css` |
| shadcn config | `components.json` |
| Component library | `src/client/components/ui/` |
| Chat components | `src/client/components/chat/` |
| Session components | `src/client/components/sessions/` |
| App state | `src/client/stores/app-store.ts` |
| Chat state | `src/client/hooks/use-chat-session.ts` |
