...
describe('TranscriptReader', () => {
    ...
    describe('listSessions()', () => {
        ...
        function mockFileHandle(content) {
            return {
        ...
        it('returns session metadata from JSONL files', async () => {
            ...
            fs.stat.mockResolvedValue(statResult);
            const file1Content = [
                JSON.stringify({
                    type: 'system',
                    subtype: 'init',
        ...
        it('uses mtime cache on second call', async () => {
            ...
            fs.open.mockResolvedValue(mockFileHandle(content));
        ...
        it('truncates long titles to 80 characters', async () => {
            fs.readdir.mockResolvedValue(['long.jsonl']);
            const statResult = {
                birthtime: new Date('2024-01-01'),
                mtime: new Date('2024-01-02'),
                mtimeMs: 1704153600000,
