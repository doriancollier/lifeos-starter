import type { Session, CreateSessionRequest, CommandRegistry, HistoryMessage, StreamEvent } from './types';
export interface Transport {
    ...
    approveTool(sessionId: string, toolCallId: string): Promise<{
        ok: boolean;
    }>;
    denyTool(sessionId: string, toolCallId: string): Promise<{
        ok: boolean;
    }>;
