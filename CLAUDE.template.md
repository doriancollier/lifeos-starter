...
User configuration lives in `.user/` directory:
...
- **health.yaml** - Health targets
- **calendars.yaml** - Calendar settings

To regenerate personalized files after config changes:
```
/system:inject      # Regenerate CLAUDE.md and coaching.md
