...
**Goal**: Move Obsidian vault content to `` subdirectory to enable a web app at root level while keeping everything in one git repository.
...
- `4-Daily/*.md` → `4-Daily/*.md`
- `2-Areas/Personal/context.md` → `2-Areas/Personal/context.md`
- `0-System/README.md` → `0-System/README.md`
...
- Example: "See `0-System/guides/...`" → "See `0-System/guides/...`"

**B. Actual code paths** (grep patterns, glob patterns)
- Functionally critical, must update
- Example: `Grep pattern in 4-Daily/` → `4-Daily/`
...
1. **VAULT_ROOT strategy**: Environment variable vs hardcoded ``?
   - Recommend: Support both (env var with `` default)
