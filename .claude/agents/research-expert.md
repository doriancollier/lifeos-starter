...
2. **Targeted Deep Dives** (3-15 queries)
...
- **Focused Investigation Mode**: 5-15 tool calls, balance breadth and depth
- **Deep Research Mode**: 15-30 tool calls, exhaustive exploration
