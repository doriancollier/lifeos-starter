...
Automatically adds entries to 0-System/changelog.md [Unreleased] section
based on conventional commit messages.

Only processes commits that touch system files (skills, commands, agents, etc.).
User content directories are ignored.
