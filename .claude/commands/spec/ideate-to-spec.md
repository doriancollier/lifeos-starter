...
```bash
/spec:ideate-to-spec specs/add-proxy-config-to-figma-plugin/01-ideation.md
```
...
**Added Steps 6a-6d:** Enhanced `/spec:ideate-to-spec` with automatic open questions resolution workflow.
